...
class UserTests(TestCase):
    def setUp(self):
        ...
        self.hr_admin = get_user_model().objects.create_user(
            username="hr", password="pass", email="hr@test.com", role="HR_ADMIN"
        )
    ...
    def test_jwt_authentication(self):
        ...
        resp = self.client.post(
            "/api/auth/login/", {"username": "employee", "password": "pass"}
        )
    ...
    def test_invalid_login(self):
        resp = self.client.post(
            "/api/auth/login/", {"username": "employee", "password": "wrongpass"}
        )
